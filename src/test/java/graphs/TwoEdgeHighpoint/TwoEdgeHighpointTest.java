...
public class TwoEdgeHighpointTest {
    ...
    public void tarjanTest1() throws Exception {
        ...
        assert( TwoEdgeHighpoint.is1EdgeConnected(G) == ConnectedResult.TwoEdgeConnected);
    }
    ...
    public void tarjanTest2() throws Exception {
        ...
        //Create the graph and print it:
        ArrayGraph G = ArrayGraph.fromString(new Scanner(f));
        assert (TwoEdgeHighpoint.is1EdgeConnected(G) == ConnectedResult.NotConnected);
    }
    ...
    public void tarjanTest3() throws Exception {
        ...
        ArrayGraph G = ArrayGraph.fromString(new Scanner(f));
        assert TwoEdgeHighpoint.is1EdgeConnected(G) == ConnectedResult.HasBridge;
    }
